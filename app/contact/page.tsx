    ...
    <div className="py-16">
      <div className="container mx-auto px-4">
        ...
        {contactInfo?.emergencyMessage && (
          <div className="max-w-4xl mx-auto mb-8 bg-accent-100 border-l-4 border-accent-500 p-4 rounded">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="font-heading font-bold text-2xl mb-6 text-primary-800">
              Send us a Message
            </h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-primary-600 hover:bg-primary-700 disabled:bg-gray-400 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all"
              >
          ...
          {/* Contact Information */}
          <div>
            <div className="bg-primary-800 text-white p-8 rounded-lg shadow-lg mb-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`tel:${contactInfo?.phone || '+1234567890'}`} className="text-accent-300 hover:text-accent-200">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${contactInfo?.email || 'info@imperiumbailbonds.com'}`} className="text-accent-300 hover:text-accent-200">
            ...
            <a
              ...
              className="block w-full text-center bg-accent-500 hover:bg-accent-600 text-white font-bold py-4 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all"
            >
