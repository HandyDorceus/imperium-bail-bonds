      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 mb-12">
            <h2 className="font-heading font-bold text-3xl mb-6 text-primary-800">
              Our Mission
            </h2>
          ...
          <div className="bg-primary-50 rounded-lg p-8 md:p-12 mb-12">
            <h2 className="font-heading font-bold text-3xl mb-6 text-primary-800">
              Our Values
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-xl mb-3 text-primary-700">Integrity</h3>
              ...
              <div>
                <h3 className="font-semibold text-xl mb-3 text-primary-700">Compassion</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="font-semibold text-xl mb-3 text-primary-700">Professionalism</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="font-semibold text-xl mb-3 text-primary-700">Availability</h3>
                <p className="text-gray-700">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-lg text-gray-700">
                  <strong>Fast Processing:</strong> We work quickly to secure release, often within hours
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-primary-600 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-lg text-gray-700">
                  <strong>Flexible Payment Plans:</strong> We offer payment options that work with your budget
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-primary-600 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-lg text-gray-700">
                  <strong>Complete Confidentiality:</strong> Your privacy is our priority
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-primary-600 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-lg text-gray-700">
                  <strong>Expert Guidance:</strong> We guide you through the entire legal process
                </span>
              </li>
            </ul>
          </div>
